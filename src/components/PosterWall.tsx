...
export default function PosterWall({ posters }: PosterWallProps) {
    ...
    return (
        <div id="poster-content" className="bg-gradient-to-b from-blue-50 to-white rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-lg border border-blue-100">
            {/* 海报头部 */}
            <div className="text-center mb-4 sm:mb-6">
                <h2 className="text-2xl sm:text-4xl font-extrabold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent tracking-wide">
                    今日AI&amp;经济资讯
                </h2>
                <p className="text-gray-400 text-xs sm:text-sm mt-1.5 sm:mt-2">{getChinaDateStr()}</p>
            </div>
            ...
            {/* 海报底部 */}
            <div className="text-center text-[10px] sm:text-xs text-gray-300 mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100">
